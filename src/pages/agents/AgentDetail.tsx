                    ...
                    <>
                      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                        ...
                        <div className="bg-teal-50 rounded-lg p-4">
                          ...
                          <div className="text-2xl font-bold text-teal-900 mt-1">${performance.totalCommissionsEarned.toLocaleString()}</div>
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
                        ...
                        <div className="bg-gray-50 rounded-lg p-4">
                          ...
                          <div className="text-xl font-bold text-gray-900 mt-1">${performance.pendingCommissions.toLocaleString()}</div>
                        </div>
                        <div className="bg-gray-50 rounded-lg p-4">
                          <div className="text-sm font-medium text-gray-600">Paid Commissions</div>
                          <div className="text-xl font-bold text-gray-900 mt-1">${performance.paidCommissions.toLocaleString()}</div>
                        </div>
                      </div>
                    </>
                  ) : (
